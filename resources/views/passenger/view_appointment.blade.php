    ...
    <div class="ui container">
        <div class="ui grid centered">
            <div class="sixteen wide column"style="margin-top:50px">
                ...
                <table class="ui table" style="text-align:center">
                    ...
                    <tr>
                        ...
                        <td>{{($appointment->vehicle_is_spesified==1)?'Aaa':'None'}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
            ...
            <div class="row">
                ...
                @else
                    <div class="four wide column">
                        <a id="book"class="ui button green fluid"href="{{route('passenger.booking.appointment.form',$appointment->id)}}">Book</a>
            </div>
                @endif
                <div class="four wide column">
