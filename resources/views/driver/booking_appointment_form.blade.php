...
@section('content')
    <div class="ui container">
        <div class="ui piled segment">
            ...
            <h1>BOOKING</h1>
            <br>
            <form class="ui form" method="GET" action="{{route('drivers.book.appointment',$appointment->id)}}">
                {{csrf_field()}}
                ...
                <div class="ui centered grid">
                    ...
                    <div class="four wide column"><button class="ui button green submit fluid">Book</button></div>
                </div>
            </form>
            <br>
        </div>
